...
register_diagnostic_define(
    ...
    diagnostic_define('template.duplicate', '{path_prefix}模板 {template!r} 重复定义（同一文件内不允许同名模板），后者被拒绝'),
    diagnostic_define('template.required_order', '{path_prefix}模板 {template!r} 中必填字段 {field!r} 出现在可选字段之后'),
    ...
    diagnostic_define('template.arg_conflict', '{path_prefix}模板 {template!r} 字段 {field!r} 同时以位置和命名参数提供'),
    diagnostic_define(
    ...
    diagnostic_define('template.null_use_nullable', '{path_prefix}期望 {template}，实际 null（使用 {template}? 允许可空）'),
    ...
    diagnostic_define('value.invalid', '{path_prefix}{message}'),
    diagnostic_define(
    ...
    diagnostic_define('constraint.expect_value', '{path_prefix}期望 {expected}，实际没有值', en='{path_prefix}expected {expected}, got no value'),
    diagnostic_define('constraint.type_mismatch', '{path_prefix}期望 {expected}，实际 {actual}', en='{path_prefix}expected {expected}, got {actual}'),
    ...
    diagnostic_define('constraint.range_below', '{path_prefix}值 {value} 小于下界 {lo}', en='{path_prefix}value {value} is below lower bound {lo}'),
    diagnostic_define('constraint.range_above', '{path_prefix}值 {value} 大于上界 {hi}', en='{path_prefix}value {value} exceeds upper bound {hi}'),
    ...
    diagnostic_define('constraint.eq_mismatch', '{path_prefix}值 {value} 不等于 {expected!r}', en='{path_prefix}value {value} does not equal {expected!r}'),
    ...
    diagnostic_define('namespace.duplicate', '{path_prefix}导入别名 {name!r} 重复绑定（$ 命名空间内不允许重复），后者被拒绝'),
)
