...
register_diagnostic_define(
    diagnostic_define('tokenize.unknown_char', '[{location}] 未知字符: {char!r}', en='[{location}] unknown character: {char!r}'),
    diagnostic_define('tokenize.unterminated_string', '[{location}] {str_type}未闭合', en='[{location}] unterminated {str_type}'),
    diagnostic_define('tokenize.unterminated_bracket', '[{location}] 括号未闭合: {bracket}', en='[{location}] unclosed bracket: {bracket}'),
    diagnostic_define('tokenize.invalid_number', '[{location}] 无效的数字字面量: {raw!r}', en='[{location}] invalid number literal: {raw!r}'),
    diagnostic_define(
